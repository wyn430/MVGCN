...
## Dataset
The experiments are conducted on [synthetic](https://drive.google.com/drive/folders/11d5L1DJomhu_RCGtVBslECfsJv48o7AC?usp=sharing) and [real-scanned](https://drive.google.com/drive/u/2/folders/1qQh3wgQQpUl0genZ-yklOI1F4FcpuhMS) 3D point cloud. To run the code directly, please download and correctly set the directory of data. The scripts of conducting clustering and calculating Geodesic distance is included in the Jupyter Notebook files.
